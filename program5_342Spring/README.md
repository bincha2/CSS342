Program 5 is a banking application that must allow for actions such as account creation, depositing funds, withdrawing funds, displaying client history, and displyaing client specific fund history. 
